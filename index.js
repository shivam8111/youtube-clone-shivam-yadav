...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=popular%20videos&key=AIzaSyCbDV8xvEzoKfmO6o2Bgh-Et2W2O0yngC4`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyCbDV8xvEzoKfmO6o2Bgh-Et2W2O0yngC4`);
let data = await res.json();
